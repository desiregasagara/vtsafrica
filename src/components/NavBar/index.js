    ...
    return(
        <div className={styles.navbar}> 
            ...
            <div className={styles.nav}>
                ...
                <a href = "https://wa.me/250788313385"><div className={styles.border2}><StaticImage src='../../images/wapp.png' alt=' Victoria Travel Whatsapp link' className={styles.clogo2}/></div></a>
